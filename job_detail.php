            ...
            <div class="lg:col-span-5 sticky top-28">
                <div class="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-lg space-y-6">
                    ...
                    <form method="POST" action="" class="space-y-4" novalidate>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="applicant_name" value="<?php echo htmlspecialchars($appOld['applicant_name'] ?? ''); ?>" placeholder="e.g. Rahul Kumar" 
                                       class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border <?php echo isset($appErrors['applicant_name']) ? 'border-rose-500 bg-rose-50/20' : 'border-slate-200'; ?> rounded-xl text-sm focus:outline-none focus:border-secondary focus:bg-white transition text-slate-800">
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="3" placeholder="Briefly mention your qualification or why you are a good fit for this role..." 
                                      class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-secondary focus:bg-white transition text-slate-800"><?php echo htmlspecialchars($appOld['notes'] ?? ''); ?></textarea>
                        </div>
                    ...
                    <div class="pt-4 border-t border-slate-100 text-center">
                        <p class="text-xs text-slate-400">Need instant assistance?</p>
                        <a href="https://wa.me/917384779569?text=Hello%20IRKGP%20Services%2C%20I%20have%20an%20inquiry%20regarding%20the%20job%20position%20<?php echo urlencode($job['title']); ?>" 
                           target="_blank" class="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-600 hover:underline mt-1">
                            <i class="fa-brands fa-whatsapp text-sm"></i> Chat with HR on WhatsApp
                        </a>
                    </div>
                </div>
            </div>
