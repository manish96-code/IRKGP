...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $errorGlobal = 'Error saving job: ' . $e->getMessage();
        }
    }
}
...
<div class="flex items-center justify-between gap-4 pb-2 border-b border-slate-200/60">
    <div>
        <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Add New Job Opening</h1>
        <p class="text-slate-500 text-xs sm:text-sm mt-0.5">Publish a new career opportunity for candidate applications.</p>
    </div>
    <div>
    ...
    <form method="POST" action="" class="space-y-6 max-w-3xl" novalidate>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="title" value="<?php echo htmlspecialchars($title); ?>" placeholder="e.g. Talent Acquisition Specialist" 
            ...
            <div>
                ...
                <input type="text" name="custom_category" id="custom-category-input" value="<?php echo htmlspecialchars($customCategory); ?>" placeholder="Type custom department / category..." 
            ...
            <div>
                ...
                <input type="text" name="custom_job_type" id="custom-jobtype-input" value="<?php echo htmlspecialchars($customJobType); ?>" placeholder="Type custom job type..." 
            ...
            <div>
                ...
                <input type="text" name="location" value="<?php echo htmlspecialchars($location); ?>" placeholder="e.g. Purnia, Bihar (HO)" 
        ...
        <div>
            ...
            <textarea name="description" rows="4" placeholder="Provide an overview of responsibilities and role summary..." 
                      class="w-full px-4 py-3 bg-slate-50 border <?php echo isset($errors['description']) ? 'border-rose-500 bg-rose-50/20' : 'border-slate-200'; ?> rounded-xl text-sm focus:outline-none focus:border-secondary focus:bg-white transition text-slate-800"><?php echo htmlspecialchars($description); ?></textarea>
        ...
        <div>
            ...
            <textarea name="requirements" rows="4" placeholder="Minimum 2+ years HR experience&#10;Strong communication skills&#10;Degree in HR" 
                      class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-secondary focus:bg-white transition text-slate-800"><?php echo htmlspecialchars($requirements); ?></textarea>
        </div>
